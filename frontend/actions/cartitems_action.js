...
export const updateCartItem = (id, cartitem, price, terms) => dispatch => {
    return APIUtil.updateCartitem(id, cartitem, price, terms).then(items => dispatch(receiveCartItems(items)));
}